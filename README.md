...
- Environment-specific configuration handled via workflow inputs and GitHub Environment secrets
...
## Repo Structure
```txt
.github/workflows/   # CI + promotion pipelines
app/                 # demo containerized service
infra/               # Terraform for AWS resources (ECR/ECS/IAM)
